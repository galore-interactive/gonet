...
namespace MessagePack
{
    ...
    public static partial class MessagePackSerializer
    {
        ...
        /// </summary>
        public static byte[] Serialize<T>(T obj, Func<int, byte[]> returnBufferCreator, out int returnBytesUsedCount)
        {
            return Serialize(obj, returnBufferCreator, out returnBytesUsedCount, defaultResolver);
        }

        /// <summary>
        /// Serialize to binary with specified resolver.
        /// </summary>
        public static byte[] Serialize<T>(T obj, Func<int, byte[]> returnBufferCreator, out int returnBytesUsedCount, IFormatterResolver resolver)
        {
            ...
            returnBytesUsedCount = formatter.Serialize(ref buffer, 0, obj, resolver);

            // do not return MemoryPool.Buffer.
            return MessagePackBinary.FastCloneWithResize(buffer, returnBytesUsedCount, returnBufferCreator);
        }
