...
namespace GONet.Generation
{
	internal sealed class GONetParticipant_AutoMagicalSyncCompanion_Generated_2 : GONetParticipant_AutoMagicalSyncCompanion_Generated
    {
        ...
        internal override void DeserializeInitAll(Utils.BitByBitByteArrayBuilder bitStream_readFrom, long assumedElapsedTicksAtChange)
        {
			...
			#if GONET_VELOCITY_SYNC_DEBUG
					GONetLog.Debug($"[VelocitySync][{gonetParticipant.GONetId}] DeserializeInitAll[7]: angularVelocity={angularVelocity}, synthesizedRotation={synthesizedValue}");
			#endif
			...
			#if GONET_VELOCITY_SYNC_DEBUG
					GONetLog.Debug($"[VelocitySync][{gonetParticipant.GONetId}] DeserializeInitAll[8]: velocity={velocity}, synthesizedValue={synthesizedValue}");
			#endif
