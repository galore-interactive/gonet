...
namespace GONet
{
	...
	[MessagePack.Union(0, typeof(GONet.AutoMagicalSync_AllCurrentValues_Message))]
		...
		[MessagePack.Union(10, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_Aim))]
		[MessagePack.Union(11, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_Fly))]
		[MessagePack.Union(12, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_Grounded))]
		[MessagePack.Union(13, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_H))]
		[MessagePack.Union(14, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_Jump))]
		[MessagePack.Union(15, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_Speed))]
		[MessagePack.Union(16, typeof(GONet.SyncEvent_AnimatorCharacterController_parameters_V))]
		[MessagePack.Union(17, typeof(GONet.SyncEvent_DestroyIfMineOnKeyPress_willHeUpdate))]
		[MessagePack.Union(18, typeof(GONet.SyncEvent_FieldChangeTest_color))]
		[MessagePack.Union(19, typeof(GONet.SyncEvent_FieldChangeTest_color_dosientos))]
		[MessagePack.Union(20, typeof(GONet.SyncEvent_FieldChangeTest_nada))]
		[MessagePack.Union(21, typeof(GONet.SyncEvent_FieldChangeTest_shortie))]
		[MessagePack.Union(22, typeof(GONet.SyncEvent_GONetParticipant_GONetId))]
...
namespace GONet.Generation
{
	public partial class BobWad
	{
		...
		static internal HashSet<GONet.Utils.QuantizerSettingsGroup> hahaThisIsTrulyTheRealness_quantizerSettings()
		{
			...
			var item_codeGenerationId2_single3_singleMember1 = new GONet.Utils.QuantizerSettingsGroup(-1.701412E+38f, 1.701412E+38f, 0, true);
			settings.Add(item_codeGenerationId2_single3_singleMember1);

			var item_codeGenerationId2_single3_singleMember2 = new GONet.Utils.QuantizerSettingsGroup(-1.701412E+38f, 1.701412E+38f, 0, true);
			settings.Add(item_codeGenerationId2_single3_singleMember2);

			var item_codeGenerationId2_single3_singleMember3 = new GONet.Utils.QuantizerSettingsGroup(-1.701412E+38f, 1.701412E+38f, 0, true);
			settings.Add(item_codeGenerationId2_single3_singleMember3);

			var item_codeGenerationId2_single3_singleMember4 = new GONet.Utils.QuantizerSettingsGroup(-1.701412E+38f, 1.701412E+38f, 0, true);
			settings.Add(item_codeGenerationId2_single3_singleMember4);

			var item_codeGenerationId2_single3_singleMember5 = new GONet.Utils.QuantizerSettingsGroup(-1.701412E+38f, 1.701412E+38f, 0, true);
			settings.Add(item_codeGenerationId2_single3_singleMember5);

			var item_codeGenerationId2_single3_singleMember6 = new GONet.Utils.QuantizerSettingsGroup(-1.701412E+38f, 1.701412E+38f, 0, true);
			settings.Add(item_codeGenerationId2_single3_singleMember6);
			...
			var item_codeGenerationId3_single3_singleMember1 = new GONet.Utils.QuantizerSettingsGroup(-5000f, 5000f, 0, true);
			...
			var item_codeGenerationId4_single2_singleMember1 = new GONet.Utils.QuantizerSettingsGroup(-5000f, 5000f, 0, true);
			...
			var item_codeGenerationId5_single2_singleMember1 = new GONet.Utils.QuantizerSettingsGroup(-5000f, 5000f, 0, true);
                            ...
                            case 7:
								{
																	...
																	System.Single valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Single : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Single; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_Speed.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            case 8:
								{
																	System.Boolean valueNew = companion.Animator.GetBool(125937960);
																	System.Boolean valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Boolean : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Boolean; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_Jump.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            case 9:
								{
																	System.Boolean valueNew = companion.Animator.GetBool(1808254291);
																	System.Boolean valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Boolean : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Boolean; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_Fly.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            case 10:
								{
																	System.Boolean valueNew = companion.Animator.GetBool(153482222);
																	System.Boolean valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Boolean : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Boolean; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_Aim.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            case 11:
								{
																	System.Single valueNew = companion.Animator.GetFloat(-1442503121);
																	System.Single valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Single : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Single; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_H.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            case 12:
								{
																	System.Single valueNew = companion.Animator.GetFloat(1342839628);
																	System.Single valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Single : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Single; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_V.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            case 13:
								{
																	System.Boolean valueNew = companion.Animator.GetBool(862969536);
																	System.Boolean valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Boolean : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Boolean; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_Grounded.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 2, syncMemberIndex, valuePrevious, valueNew);
								}
                            ...
                            case 11:
								{
																	System.Boolean valueNew = companion.Animator.GetBool(862969536);
																	System.Boolean valuePrevious = explanation == SyncEvent_ValueChangeProcessedExplanation.OutboundToOthers ? companion.valuesChangesSupport[syncMemberIndex].lastKnownValue_previous.System_Boolean : companion.valuesChangesSupport[syncMemberIndex].lastKnownValue.System_Boolean; // because of order of operations and state of affairs at the time of publishing this event being different for the in/out direction, there is a different value to pull from that represents the previous value
									return SyncEvent_AnimatorCharacterController_parameters_Grounded.Borrow(explanation, elapsedTicks, filterUsingOwnerAuthorityId, syncCompanion.gonetParticipant.GONetId, 5, syncMemberIndex, valuePrevious, valueNew);
								}
